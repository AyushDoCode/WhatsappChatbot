    ...
    def start_scheduler(self):
        ...
        while True:
            try:
                ...
                # Window is 0:00 - 5:59 (12 AM - 6 AM)
                current_hour_ist = self.get_ist_time().hour
                if self.is_running and current_hour_ist >= 6:
                    logger.warning(f"⚠️  Job running outside scheduled window (IST time: {current_hour_ist}:00), will complete current job and stop")
