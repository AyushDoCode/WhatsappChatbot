"""
Visual Search Engine v2 - TEST Indexer (10 products only)
...
class VectorIndexerV2:
    ...
    def __init__(self):
        ...
        print("🚀 Initializing Visual Search Indexer V2 (TEST MODE - 10 products)...")
    ...
    def fetch_products(self) -> List[Dict]:
        ...
        if TEST_MODE:
            products = list(self.collection.find().limit(MAX_TEST_PRODUCTS))
            print(f"✅ TEST MODE: Fetching only {len(products)} products")
        else:
...
if __name__ == "__main__":
    print("=" * 70)
    print("  VISUAL SEARCH ENGINE V2 - TEST INDEXER (10 Products)")
